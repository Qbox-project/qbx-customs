ModTypes = {
    ...
    [27] = {name = "VMT_INTERIOR1", label = "Trim A", num = 27},
    [28] = {name = "VMT_INTERIOR2", label = "Ornaments", num = 28},
    [29] = {name = "VMT_INTERIOR3", label = "Dashboard", num = 29},
    [30] = {name = "VMT_INTERIOR4", label = "Dial", num = 30},
    [31] = {name = "VMT_INTERIOR5", label = "Door Speaker", num = 31},
    [32] = {name = "VMT_SEATS", label = "Seats", num = 32, bone = "seat_pside_f"},
    [33] = {name = "VMT_STEERING", label = "Steering", num = 33, bone = "steeringwheel"},
    [34] = {name = "VMT_KNOB", label = "Knob", num = 34},
    [35] = {name = "VMT_PLAQUE", label = "Plaque", num = 35},
    [36] = {name = "VMT_ICE", label = "Speaker", num = 36},
    [37] = {name = "VMT_TRUNK", label = "Trunk", num = 37, bone = "boot"},
    [38] = {name = "VMT_HYDRO", label = "Hydro", num = 38},
    [39] = {name = "VMT_ENGINEBAY1", label = "Engine Block", num = 39},
    [40] = {name = "VMT_ENGINEBAY2", label = "Air Filter", num = 40},
    [41] = {name = "VMT_ENGINEBAY3", label = "Strut", num = 41},
    [42] = {name = "VMT_CHASSIS2", label = "Arch Cover", num = 42, bone = "chassis"},
    [43] = {name = "VMT_CHASSIS3", label = "Aerial", num = 43, bone = "chassis"},
    [44] = {name = "VMT_CHASSIS4", label = "Trim B", num = 44, bone = "chassis"},
    [45] = {name = "VMT_CHASSIS5", label = "Fuel Tank", num = 45, bone = "chassis"},
    [46] = {name = "VMT_DOOR_L", label = "Window", num = 46, bone = "handle_dside_f"},
